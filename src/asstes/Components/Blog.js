    ...
    <Container>
        ...
        <section className='page-section'>
          <div className='steps-container'>
            ...
            {/* Description */}
            <p className="text">
            Stay updated with the latest travel trends, tips, and destination guides to plan your perfect adventure.
            </p>
            <div>
              <div className='row'>
                ...
                <div className='col-lg-4 col-md-6 col-sm-6 mb-4'>
                  <div className='card-Offers'>
                    <div className='card-body post-info'>
                      <div className='image-wrapper'> 
                        <img src={post3} alt="Santorini" className="tourimage card-image" />
                      </div>
                      <div className="tourcontent">
